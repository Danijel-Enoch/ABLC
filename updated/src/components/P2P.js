                ...
                <div class="p2p-a">
                    <div class="p2p-a-nav">
                        ...
                        <div class="p2p-a-nav-div2">
                            ...
                            <div class="p2p-a-nav-div2-new-btn" >< ConnectButton /></div>
                        </div>
                    </div>
                    <div class='p2p-a-div1'>
                        <span class="p2p-a-div1-line1">ARABELLA P2P EXCHANGE</span>
                        <span class="p2p-a-div1-line2">Empowers You To Exchange ABLC Tokens With BNB, BUSD & USDT With Other Traders Instantly.</span>
                        <div class="p2p-a-div1-line3">Liquidity less <span class="p2p-a-div1-line3-active">Buying & Selling of ABLC tokens</span> in no time.</div>
                    </div>
                                    ...
                                    <div class="p2p-b-box1-container">
                                        <div class="p2p-b-box-div1">
                                            <div class="p2p-b-box-div1a">
                                                ...
                                                <span class="p2p-b-box-div1a-line2">${price}</span>
                                            </div>
                                        ...
                                        <div class="p2p-b-box-div1">
                                            <div class="p2p-b-box-div1a">
                                                ...
                                                <span class="p2p-b-box-div1a-line2">${dPrice}</span>
                                            </div>
                                            {/* <div class="p2p-b-box-div1b"> */}
                                            <select onChange={(e) => {
